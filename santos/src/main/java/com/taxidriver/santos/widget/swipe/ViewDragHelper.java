...
package com.taxidriver.santos.widget.swipe;
...
public class ViewDragHelper {
    ...
    /**
     * A ResponseCallback is used as a communication channel with the ViewDragHelper
    ...
    public static abstract class Callback {
         ...
         * {@link #flingCapturedView(int, int, int, int)}. If the ResponseCallback
     ...
     * @param cb        ResponseCallback to provide information and receive events
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        ...
        if (cb == null) {
            throw new IllegalArgumentException("ResponseCallback may not be null");
        }
     ...
     * greater than zero in pixels per second. ResponseCallback methods accepting a
     ...
     * magnitude less than this value in pixels per second. ResponseCallback methods
    ...
    public boolean settleCapturedViewAt(int finalLeft, int finalTop) {
        if (!mReleaseInProgress) {
            throw new IllegalStateException("Cannot settleCapturedViewAt outside of a call to "
                    + "ResponseCallback#onViewReleased");
        }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                for (int i = 0; i < pointerCount; i++) {
                    ...
                    if (mDragState == STATE_DRAGGING) {
                        // ResponseCallback might have started an edge drag
                        break;
                    }
