...
//        mCustomMsgView = (TextView) mCustomView.findViewById(R.id.custom_toast_msg);
        mCustomMsgView = (TextView) mCustomView.findViewById(0);
    ...
    public static void show(CharSequence msg, int duration) {
        getToast();
        showHelper(msg, Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, sSmartToast.mVerticalAxisOffset, duration);
    }

    public static void showAtTop(CharSequence msg, int duration) {
        getToast();
        showHelper(msg, Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, sSmartToast.mVerticalAxisOffset, duration);
    }

    public static void showInCenter(CharSequence msg, int duration) {
        getToast();
        showHelper(msg, Gravity.CENTER, 0, 0, duration);
    }

    public static void showAtLocation(CharSequence msg, int gravity, int xOffsetDp, int yOffsetDp, int duration) {
        getToast();
        ...
        showHelper(msg, gravity, xOffset, yOffset, duration);
    }


    public static void showLong(CharSequence msg, int duration) {
        getToast();
        showHelper(msg, Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, sSmartToast.mVerticalAxisOffset, duration);
    }

    public static void showLongAtTop(CharSequence msg, int duration) {
        getToast();
        showHelper(msg, Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, sSmartToast.mVerticalAxisOffset,duration);
    }

    public static void showLongInCenter(CharSequence msg, int duration) {
        getToast();
        showHelper(msg, Gravity.CENTER, 0, 0, duration);
    }

    public static void showLongAtLocation(CharSequence msg, int gravity, int xOffsetDp, int yOffsetDp, int duration) {
        getToast();
        int xOffset = Math.round(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, xOffsetDp, sSmartToast.mAppContext.getResources().getDisplayMetrics()));
        int yOffset = Math.round(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, yOffsetDp, sSmartToast.mAppContext.getResources().getDisplayMetrics()));
        showHelper(msg, gravity, xOffset, yOffset, duration);
